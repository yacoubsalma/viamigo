...
let ParseObjectIdPipe = class ParseObjectIdPipe {
    transform(value) {
        if (!mongoose_1.Types.ObjectId.isValid(value) || value.length !== 24) {
            throw new common_1.BadRequestException(`Invalid ObjectId: ${value}. It must be a 24-character hex string.`);
        }
